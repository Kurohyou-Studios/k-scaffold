...
const { data:origData,type:libraryType } = defineProps(['data','type']);
...
<div class="library-container">
  ...
  <div class="library-content">
    <slot></slot>
    <LibraryCard v-if="!libraryType || libraryType === 'jsdoc'" v-for="entry,index in data" :key="`entry-${index}`" :entry="{...entry,index}"/>
  </div>
</div>
</template>
