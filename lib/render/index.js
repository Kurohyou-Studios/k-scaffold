 ...
 * @param {object} [kRequire] - A NodeJS `require` function to pass to the PUG runtime to be able to import additional files from the PUG.
 ...
 */
const build = async ({ source = './', destination, dynamicDestination, testDestination, pugOptions = { suppressStack: true }, scssOptions = {}, kRequire = null, watch = false, templates, sfc }) => {
  pugOptions = { ...pugOptions, _kRequire: kRequire || require };
