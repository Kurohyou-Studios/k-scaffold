 ...
 * this function.
 * @param {Object} param0 An object that contains the `trigger`, `attributes` and `sections`
...
const kAddNestedItem = function({trigger, attributes, sections}) {
    ...
    k.debug({event: 'kAddNestedItem', section, selector, level, sections, rowid, newChildID});
    return newChildID;
};
k.registerFuncs({kAddNestedItem});
