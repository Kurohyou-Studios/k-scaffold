  ...
  const repeatHandler = {
    ...
    set: function(obj,prop,value){
      if(prop === '_id' || prop === '_section'){
        debug(`!!!Warning: cannot change the id or section of a repeating object!!!`);
        return false;
      }else if( prop === '_index'){
        debug(`!!!Warning: Cannot reorder sections by setting the _index. Sort the repeating array or use k.setSectionOrder!!!`);
      }
