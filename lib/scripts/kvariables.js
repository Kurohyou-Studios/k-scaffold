...
const kscaffoldJSVersion = '2.5.4';
const kscaffoldPUGVersion = '2.5.4';
/**
 * Defines the rollstring that rolls made using k.startRoll begin with. Defaults to "&{template:default}". Can be overriden by passing a custom string as the second argument to k.startRoll.
 * @memberof Variables
 * @var
 * @type {string}
 */
