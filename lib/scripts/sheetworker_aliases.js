...
/**
 * Alias for Roll20's [startRoll function](https://wiki.roll20.net/Sheetworkers#Custom_Roll_Parsing) that takes an object instead of a string. This can make it easier to work with complex roll template constructions
 * @memberof Sheetworker Aliases
 * @name startRoll
